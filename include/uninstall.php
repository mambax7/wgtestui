 ...
 */
function xoops_module_pre_uninstall_wgtestui(\XoopsModule $module)
{
 ...
 */
function xoops_module_uninstall_wgtestui(\XoopsModule $module)
{
    ...
    if (is_file($xmlfile)) {
        if (false === ($delOk = \unlink($xmlfile))) {
            $module->setErrors(\sprintf(\_AM_WGTESTUI_ERROR_BAD_REMOVE, $xmlfile));
        }
    }
